...
export function DropdownToggle({ sessionTitle, isOpen, onClick }: DropdownToggleProps) {
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-1 px-2 py-0.5 text-[1rem] text-text-secondary hover:text-text-primary hover:bg-surface-hover rounded transition-colors min-w-0 max-w-full"
    >
